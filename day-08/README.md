...
- You have to give the --env-file to Deno when getting the data from the .env file. If you just use Deno run it won't ask you for it and only return undefined instead of the value you asked for.
